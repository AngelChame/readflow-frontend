...
export function LogoutButton() {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="w-full flex flex-col md:flex-row items-center text-xs md:text-base md:gap-3 p-2 text-foreground hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg font-base transition-colors group text-left"
    >
