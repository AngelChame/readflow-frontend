...
export default function FillInQuiz({ data }: Props) {
    ...
    const allBlanksFilledForCurrent = q.blanks.every((_, i) => currentAnswers[i] !== undefined)
    ...
    if (finished && result) {
        ...
        return (
            <div className="w-full h-full bg-background-secondary rounded-2xl p-8 shadow-sm space-y-9">
                <div>
            ...
            <div className="w-full space-y-12">
                ...
                <div>
                    ...
                    <p className="text-sm text-foreground mt-1">
                        <span className="font-semibold">Instrucciones:</span> Completa el párrafo con las palabras en el recuadro.
                    </p>
                    <p className="text-sm text-muted-foreground mt-0.5">
                        <span className="font-semibold">Nota:</span> Se encuentran algunas palabras trampa.
                    </p>
                </div>
