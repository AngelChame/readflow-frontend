...
import {
  ...
  isFillIn,
  isWriting,
} from "@/types/api/quiz/quiz.response";
  ...
  if (showUnavailableModal) {
    return (
      <div className="w-full h-full bg-background flex items-center justify-center p-6">
        <div className="w-full max-w-md bg-background-secondary rounded-2xl p-5 sm:p-8 shadow-sm space-y-4 text-center flex flex-col items-center">
          ...
          <p className="text-muted-foreground text-sm">
            ...
            Regresa cuando hayan pasado las 48 horas para completar tu repaso
            espaciado.
          </p>
          <button
