    ...
    return (
        <main className="py-6 px-10 bg-background min-h-screen w-full h-full flex justify-center">
            <div className="w-full grid grid-cols-[45%_45%] gap-[10%]">
                <div className="rounded-3xl h-full w-full flex flex-col justify-between px-10 py-16 bg-[url('/gifs/auth.gif')] bg-no-repeat shadow-[0_5px_30px_rgba(91,106,235,0.6)]">
                ...
                <div className="grid grid-rows-[auto_1fr] gap-10 pl-20 pr-30 py-24 text-foreground self-center">
                    ...
                    <div className="flex flex-col gap-8">
                        <form action="" className="flex flex-col gap-2">
                            ...
                            <input type="submit" value="Iniciar sesión" className="text-lg py-2 px-10 bg-main-purple text-white font-bold rounded-xl mt-8 w-full self-center cursor-pointer transition-all duration-300 hover:shadow-[0_5px_20px_rgba(91,106,235,0.7)] hover:scale-[1.02]"/>
                        </form>

                        <div className="text-center">
                            <h4 className="font-light text-foreground">¿Aún no tienes una cuenta? <Link href="/register" className="font-bold text-main-purple transition-all duration-300 hover:text-shadow-[0_5px_20px_rgba(91,106,235,0.7)]">Regístrate</Link></h4>
                        </div>
                    </div>
                </div>
            </div>
