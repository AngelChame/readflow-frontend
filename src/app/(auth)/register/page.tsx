                ...
                <div className="grid grid-rows-[auto_1fr] gap-10 pl-30 pr-20 py-24 text-foreground self-center">
                    ...
                    <div className="flex flex-col gap-8">
                        <form action="" className="flex flex-col gap-2">
                            ...
                            <input type="submit" value="Crear cuenta" className="text-lg py-2 px-10 bg-main-purple text-white font-bold rounded-xl mt-8 w-full self-center cursor-pointer transition-all duration-300 hover:shadow-[0_5px_20px_rgba(91,106,235,0.7)] hover:scale-[1.02]"/>
                        </form>

                        <div className="text-center">
                            <h4 className="font-light text-gray-500">¿Ya tienes una cuenta? <Link href="/login" className="font-bold text-main-purple transition-all duration-300 hover:text-shadow-[0_5px_20px_rgba(91,106,235,0.7)]">Inicia sesión</Link></h4>
                        </div>
                    </div>
                </div>
